...
// About Us Page - Different color (emerald/green)
export const InteractiveGridColored: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden z-0 pointer-events-none">
      {cells.map((cell, index) => (
        <div
          key={index}
          className="absolute border border-emerald-400 transition-all duration-300 ease-out pointer-events-none"
          style={{
            left: cell.x,
            top: cell.y,
            width: gridSize,
            height: gridSize,
            backgroundColor: cell.active ? 'rgba(52, 211, 153, 0.2)' : 'transparent',
            borderColor: cell.active ? 'rgba(52, 211, 153, 0.6)' : 'rgba(52, 211, 153, 0.1)',
