...
test.describe('Checkout Flow Compliance', () => {
    ...
    test('should display strict execution authorization copy', async ({ page }) => {
        ...
        const executeBtn = page.getByRole('button', { name: /Execute Document|Get Started|Transact/i }).first();
        ...
        const disclaimer = page.getByText('Payment is the sole causal act. This action authorizes exactly one irreversible execution.');
