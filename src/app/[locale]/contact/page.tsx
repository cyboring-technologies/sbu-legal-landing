...
export default function ContactPage() {
  ...
  return (
    <Layout>
      ...
      {/* Contact Form & Map */}
      <section id="contact-form" className="py-20 bg-background border-b border-border relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            {/* Form */}
            <div className="lg:col-span-2 mt-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl">
              {t('alternativeContact.title')}
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              {t('alternativeContact.subtitle')}
            </p>
          </div>
