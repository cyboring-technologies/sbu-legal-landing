  ...
  return (
    <Layout>
      <PageTransition>
        ...
        {/* Supply Packs - Main Product */}
        <section id="pricing-plans" className="py-32 bg-background border-b border-border relative overflow-hidden">
            ...
            <StaggeredGrid columns={4}>
              ...
              <HoverCard className="flex flex-col h-full overflow-hidden">
                  ...
                  <div className="mt-6">
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <Check className="w-5 h-5 text-gray-500 mr-2 flex-shrink-0" />
                ...
                <div className="px-6 pb-8">
                  <CTAButton href="/contact" variant="secondary" size="md" className="w-full justify-center" ctaType="cta-2">
                    {t('packages.items.founder.cta_1_activate')}
                  </CTAButton>
                </div>
              </HoverCard>
              ...
              <HoverCard className="flex flex-col h-full overflow-hidden">
                ...
                <div className="px-6 pb-8">
                  <CTAButton href="/contact" variant="primary" size="md" className="w-full justify-center" ctaType="cta-2">
                    {t('packages.items.solo.cta_2_getStarted')}
                  </CTAButton>
                </div>
              </HoverCard>
              ...
              <HoverCard className="flex flex-col h-full overflow-hidden border-2 border-primary transform scale-105 z-10">
                ...
                <div className="px-6 pb-8">
                  <CTAButton href="/contact" variant="primary" size="md" className="w-full justify-center" ctaType="cta-2">
                    {t('packages.items.firm.cta_2_getStarted')}
                  </CTAButton>
                </div>
              </HoverCard>
              ...
              <HoverCard className="flex flex-col h-full overflow-hidden bg-gray-50 dark:bg-gray-800">
                ...
                <div className="px-6 pb-8">
                  <CTAButton href="/contact" variant="primary" size="md" className="w-full justify-center" ctaType="cta-2">
                    {t('packages.items.factory.cta_2_getStarted')}
                  </CTAButton>
                </div>
              </HoverCard>
            </StaggeredGrid>
            ...
            <FadeIn>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-gray-600 dark:text-gray-300">
                <div className="flex items-center justify-center sm:justify-start">
                  <Check className="w-6 h-6 text-gray-500 mr-3 flex-shrink-0" />
