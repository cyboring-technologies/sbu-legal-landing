...
export default function BlogPage() {
    ...
    return (
        <Layout>
            ...
            {/* Newsletter Section */}
            <section id="newsletter" className="py-20 bg-gray-50 dark:bg-gray-900/50 border-b border-border relative">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <div className="inline-flex items-center justify-center p-3 sm:p-4 bg-blue-100 dark:bg-blue-900/30 rounded-full mb-6">
