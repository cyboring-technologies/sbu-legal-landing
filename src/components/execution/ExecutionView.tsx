...
type ExecutionStatus = 'INIT' | 'UPLOADING' | 'ANALYZING' | 'WAITING_METADATA' | 'READY_TO_GENERATE' | 'GENERATING' | 'REVIEWING' | 'COMPLETED' | 'INCINERATED' | 'ERROR';
...
export const ExecutionView: React.FC<ExecutionViewProps> = ({ file, token, onReset, draftType }) => {
    ...
    return (
        <div data-debug="ENGINE-GRID-ROOT" className="w-full h-full p-4 grid grid-cols-3 gap-6 bg-background">
            ...
            <div className="lg:col-span-1 bg-card rounded-lg shadow border p-4 flex flex-col">
                ...
                <div className="mb-4">
                    ...
                    <div className="overflow-y-auto max-h-[150px] border rounded bg-muted/30 p-2 mt-2">
                        {structure.length > 0 ? structure.map((s, i) => (
                    ...
                    <div className="flex-1 flex flex-col min-h-0">
                        ...
                        <div className="flex-1 overflow-y-auto text-xs space-y-4 mb-2 p-2 border rounded bg-muted/30">
                            ...
                            <div>
                                ...
                                {metadata.structural.jurisprudence.length === 0 && <span className="text-gray-400 italic">No citations found.</span>}
                            </div>
                        </div>
                        <button
            ...
            <div className="lg:col-span-1 bg-card rounded-lg shadow border p-4 flex flex-col">
                ...
                {draftHtml && (
                    <div className="flex-1 overflow-y-auto prose dark:prose-invert text-sm p-2 border rounded bg-muted/40 mb-4"
