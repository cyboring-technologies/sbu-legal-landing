      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <HoverCard className="p-8 group">
            ...
            <p className="text-gray-600 dark:text-gray-300">{t('items.item1.description')}</p>
          </HoverCard>
          ...
          <HoverCard className="p-8 group">
            ...
            <p className="text-gray-600 dark:text-gray-300">{t('items.item2.description')}</p>
          </HoverCard>
          ...
          <HoverCard className="p-8 group">
            ...
            <p className="text-gray-600 dark:text-gray-300">{t('items.item3.description')}</p>
          </HoverCard>
        </div>
      </div>
    </section>
